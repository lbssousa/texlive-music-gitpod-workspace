# Generated by Powerlevel10k configuration wizard on 2022-05-02 at 00:47 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 51782.
# Wizard options: powerline, lean_8colors, unicode, 24h time, 2 lines, dotted, no frame,
